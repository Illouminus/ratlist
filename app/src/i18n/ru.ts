...
export const ru: Translation = {
  ...
  visibility: {
    shared: 'Открыто',
    private: 'Только я',
    sharedHelp: 'Видят твои крысы в приложении — и любой, кому ты дал ссылку на список.',
    privateHelp: 'Видишь только ты. Ни крысы, ни по ссылке не увидят.',
  },
  categories: {
  ...
  events: {
    eyebrow: 'события',
    title: 'к чему дарить',
    sub: 'др, праздники, новоселья — поводы, к которым ты собираешь подборку из своего списка. гости видят по ссылке только её, а не весь список.',
  ...
  landing: {
    ...
    sub: 'добавляй крыс, делись списком по ссылке — они видят, что ты правда хочешь, а ты не знаешь, кто что займёт. без ленты, без алгоритмов, без рекламы. бумажный вайб, ничего лишнего.',
    primaryCta: 'войти →',
    primaryCtaHint: 'magic link на email — без паролей',
    inviteHint: 'звали? открой ссылку из чата',
    featuresEyebrow: 'что есть',
    feature1Title: 'своя\nстая',
    feature1Body: 'добавляешь крыс — они видят твой список, ты видишь их. без алгоритмов и рекламы, только свои.',
    feature2Title: 'тайный\nсанта',
    feature2Body: 'жеребьёвка с исключениями для пар. результат видишь только ты — пока организатор не откроет всем.',
    feature3Title: 'по\nсекрету',
    feature3Body: 'крысы разбирают подарки из твоего списка — а ты не видишь, кто что забрал. никаких спойлеров до самого дня.',
    ...
    howTitle: 'три шага',
    how1Title: 'заведи список',
    how1Body: 'кидаешь ссылку — мы достаём картинку, цену и название. остальное допишешь парой слов.',
    how2Title: 'позови крыс',
    how2Body: 'отправь крысе свою ссылку — и вы видите вишлисты друг друга. прямо из чата или по почте.',
    how3Title: 'делись',
    how3Body: 'дай ссылку на список кому угодно — даже тем, кто не в приложении. посмотрят без регистрации.',
    ctaEyebrow: 'пора?',
  ...
  publicList: {
    ...
    ctaEyebrow: 'тоже хочешь такой?',
    makeYourOwn: 'заведи свой список',
    makeYourOwnBody:
      'бесплатно, без рекламы и алгоритмов. собери вишлист за минуту и кидай друзьям ссылкой.',
    makeYourOwnCta: 'начать →',
    addOwnerBody: 'добавь {name} в крысы — будете видеть списки друг друга прямо в приложении.',
    addOwner: '+ добавить {name} в крысы',
    addOwnerBusy: 'добавляем…',
    addedOwner: 'теперь вы крысы с {name}',
    addedToast: '{name} теперь в твоих крысах',
    openList: 'открыть в приложении →',
    yourList: 'это твой список.',
    yourListCta: 'редактировать →',
  },
  invite: {
    eyebrow: 'приглашение',
  ...
  errors: {
    ...
    tokenExpired: 'У ссылки истёк срок.',
