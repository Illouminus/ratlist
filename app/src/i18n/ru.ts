...
export const ru: Translation = {
  ...
  item: {
    ...
    confirmDelete: 'точно вычеркнуть?',
  ...
  groups: {
    ...
    delete: 'удалить круг',
    deleting: 'удаляем…',
    deleteConfirm: 'удалить «{name}»? это нельзя отменить — все ссылки-приглашения тоже исчезнут.',
    membersTitle: 'участники',
    youBadge: 'ты',
    promote: 'сделать админом',
    demote: 'снять с админа',
    kick: 'выгнать',
    kickConfirm: 'выгнать {name} из «{group}»?',
    leave: 'покинуть круг',
    leaveConfirm: 'покинуть «{name}»? твои айтемы останутся в твоём списке, но перестанут быть видны крысятам из этого круга.',
    leaving: 'выходим…',
  },
  santa: {
